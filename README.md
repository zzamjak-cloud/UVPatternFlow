...
```
https://github.com/zzamjak-cloud/UVPatternFlow.git
```

특정 버전을 설치하려면 태그를 붙입니다.

```
https://github.com/zzamjak-cloud/UVPatternFlow.git#v1.0.0
```
...
{
  "dependencies": {
    "com.zzamjak.uvpatternflow": "https://github.com/zzamjak-cloud/UVPatternFlow.git#v1.0.0"
  }
}
```
